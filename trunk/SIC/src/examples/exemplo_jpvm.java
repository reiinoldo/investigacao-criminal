...
public class exemplo_jpvm {
	...
	public static void main(String[] args) {
		try {
			...
			// definir se ̩ o master, ou se ̩ algum escravo.
			if (masterTaskId == jpvm.PvmNoParent) {
				...
				for (i = 0; i < num_workers; i++) {
					...
					System.out.println(testeSerial.getNome());
				...
				jpvmMessage message = jpvm.pvm_recv();
				byte[] retorno = null;
				message.buffer.unpack(retorno, 10000, 1);
